...
public class Increase_Speed extends CommandBase {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  Shooter shooter;
  double FrontshooterSpeed;
  double BackshooterSpeed;
  /**
   * Creates a new Increase_Speed
   *.
   *
   * @param subsystem The subsystem used by this command.
   */
  public Increase_Speed(Shooter subsystem, double FrontshooterSpeed, double BackshooterSpeed) {
